...
def play_alarm_sound_function(): # defined function to play alarm post fire detection using threading
    playsound.playsound('audio.mp3',True) # to play alarm # mp3 audio file is also provided with the code.
...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "nokibkamran1998@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("nokibkamran1998@gmail.com", 'artnzgbqsxwaxouw') # Senders mail ID and password
        server.sendmail('nokibkamran1998@gmail.com', recipientmail, "Warning fire is Detected") # recipients mail with mail message
